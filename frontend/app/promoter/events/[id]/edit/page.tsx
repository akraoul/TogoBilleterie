...
export default function EditEventPage() {
    ...
    useEffect(() => {
        const fetchEvent = async () => {
            try {
                const response = await api.get(`/events/${id}`); // Assuming public get works, or adding public endpoint for single event is needed? 
                // Wait, if promoter, they should use /events/my and filter? Or we need /promoter/events/:id
                // Currently GET public/events/:id exists? No, only list. 
                // We might need to add GET /promoter/events/:id or just GET /events/:id (public)
                // Let's assume we can GET /public/events/:id or similar.
                // Actually my routes.ts has GET /public (list) and GET /my (list). 
                // Missing GET /:id for detail!
                // I will add GET /:id public route later, or rely on passing data? No, refresh needs fetch.
                // Let's assume I'll add GET /events/:id public or protected.
                // For now, let's try GET /public/events/:id if I added it, but I didn't. 
                // I will update the backend to allow fetching single event details.

                // Temporary fix: Fetch all my events and find the one.
                const myEventsRes = await api.get('/admin/events/my'); // Wait, route is /api/admin/events/my? No, /api/events/my
                const event = myEventsRes.data.find((e: any) => e.id === parseInt(id as string));
                ...
                if (event) {
                    ...
                    setFormData({
                        ...
                        tmoneyNumber: event.tmoneyNumber || '',
                        floozNumber: event.floozNumber || ''
                    });
    ...
    if (isFetching) return <div className="p-8 text-center">Chargement...</div>;

    return (
        <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">Modifier l'événement</h2>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-togo-green focus:border-togo-green sm:text-sm py-3 border text-gray-900 bg-white placeholder-gray-400"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-togo-green focus:border-togo-green sm:text-sm py-3 border text-gray-900 bg-white placeholder-gray-400"
                                >
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    value={formData.date}
                                    onChange={handleChange}
                                    className="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-togo-green focus:border-togo-green sm:text-sm py-2 border px-3 text-gray-900 bg-white placeholder-gray-400"
                                />
                                <input
                                    type="time"
                                    name="time"
                                    ...
                                    value={formData.time}
                                    onChange={handleChange}
                                    className="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-togo-green focus:border-togo-green sm:text-sm py-2 border px-3"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-togo-green focus:border-togo-green sm:text-sm py-2 border text-gray-900 bg-white placeholder-gray-400"
                                />
                            </div>
                        </div>
                    </div>
                                ...
                                <div key={index} className="flex gap-2 items-start bg-gray-50 p-3 rounded-lg border border-gray-200">
                                    <div className="flex-1">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-togo-green focus:border-togo-green sm:text-sm py-2 px-3 text-gray-900 bg-white placeholder-gray-400"
                                        />
                                    </div>
                                    <div className="w-24">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        value={formData.tmoneyNumber}
                                        onChange={handleChange}
                                        className="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-togo-green focus:border-togo-green sm:text-sm py-2 border"
                                    />
                                </div>
                            </div>
                            <div className="relative">
